...
data_info='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AniaB/ELP_SemPhon_HLE/data_covariates.xlsx'; %final_sample sheet, the subject column should have sub plus subject number.(e.g. sub-5003)
if isempty(subjects)
