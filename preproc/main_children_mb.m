...
%heavily modified based on lab pipeline by Jin Wang 1/5/2021
...
tpm='/dors/booth/JBooth-Lab/BDL/LabCode/typical_data_analysis/templates_cerebroMatic/ELP_55_85Template/mw_com_prior_Age_0084.nii'; %This is the template path used for 5 year olds
%use line below for 7 year old age group
%tpm='/dors/booth/JBooth-Lab/BDL/LabCode/typical_data_analysis/templates_cerebroMatic/ELP_ses_7/mw_com_prior_Age_0096.nii'; 
addpath(genpath(spm_path));

root='/dors/booth/JBooth-Lab/BDL/AniaB/ELP_SemPhon_HLE'; %This is your project folder
subjects={}; %manually put subject numbers say 'sub-5004' 'sub-5009', or leave this empty if you have an excel with data_info.

%data_info sheet changes based on age group
