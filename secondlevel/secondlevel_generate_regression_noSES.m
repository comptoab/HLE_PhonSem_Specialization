...
data_info='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AniaB/ELP_SemPhon_HLE/data_covariates_rerun_final.xlsx'; %your subject list excel, if you have regressors, it's better there too.
if isempty(subjects)
    M=readtable(data_info);
    subjects=M.subjects;
end

out_dir='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AniaB/ELP_SemPhon_HLE/secondlevel_results/rerun_age_good_regression_sem_FamilyToChild_noSES_test'; % your output folder of secondlevel analysis results
...
global CCN;
CCN.session='ses-7'; %also run analyses with ses-5 for additional age group 
...
cov_num=3; %number of your covariates, change to 4 if including SES below
%you can define as many covariates as you want by adding name and values.
if cov==1
    name=[];
    name{1}='FamilyToChild'; %covariate of interest
    %complete analyses with and without the line below commented out, for analyes with and without SES as a covariate of no interest
    ...
    name{2}='Acc_SEM_mean';% This should be your column header in your excel
