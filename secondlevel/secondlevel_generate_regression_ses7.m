...
out_dir='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/AniaB/ELP_SemPhon_HLE/secondlevel_results/rerun_age_good_regression_Phon_ChildAlone'; % your output folder of secondlevel analysis results
...
cov_num=4; %number of your covariates
...
if cov==1
    ...
    name{3}='Acc_PHON_mean';% This should be your column header in your excel
    name{4}='Age_M_mean';% This should be your column header in your excel
    val=[];
    for v=1:length(name)
        val{v}=M{:,name{v}};
    end
